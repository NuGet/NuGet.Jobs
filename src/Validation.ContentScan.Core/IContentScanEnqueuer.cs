...
namespace NuGet.Jobs.Validation.ContentScan
{
    public interface IContentScanEnqueuer
    {
        ...
        /// <param name="pkgUrl">Url of the package to scan.</param>
        Task EnqueueContentScanAsync(Guid validationId, Uri contentUri);
        ...
        Task EnqueueContentScanAsync(Guid validationId, Uri contentUri, TimeSpan messageDeliveryDelayOverride);
    }
}