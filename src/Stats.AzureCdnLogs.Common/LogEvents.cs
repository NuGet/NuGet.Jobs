...
namespace Stats.AzureCdnLogs.Common
{
    public class LogEvents
    {
        ...
        public static EventId FailedToCheckAlreadyProcessedLogFilePackageStatistics = new EventId(513, "Failed to check if already processed package statistics for log file");
        public static EventId FailedToCheckAlreadyProcessedLogFileToolStatistics = new EventId(514, "Failed to check if already processed tool statistics for log file");
