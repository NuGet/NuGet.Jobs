...
:Top
    ...
    start /w search.generateauxiliarydata.exe -Configuration "#{Jobs.search.generateauxiliarydata.ussc.Configuration}" -verbose true -Sleep #{Jobs.search.generateauxiliarydata.Sleep} -InstrumentationKey "#{Jobs.search.generateauxiliarydata.ApplicationInsightsInstrumentationKey}"
