    ...
    public class ValidatorStatusExtensionsFacts
    {
        public class ToNuGetValidationResponse
        {
            ...
            public void RejectsNullValidatorStatus()
            {
                ...
                // Act & Assert
                var ex = Assert.Throws<ArgumentNullException>(() => validatorStatus.ToValidationResponse());
            ...
            public void RejectsNullValidatorIssues()
            {
                ...
                // Act & Assert
                var ex = Assert.Throws<ArgumentException>(() => validatorStatus.ToValidationResponse());
            ...
            public void AllowsEmptyIssueList()
            {
                ...
                // Act
                var result = validatorStatus.ToValidationResponse();
