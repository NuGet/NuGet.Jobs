...
{
    public class PackageSigningProcessorFacts
    {
        ...
        public abstract class FactsBase
        {
            ...
            protected readonly ILogger<PackageSigningProcessor> _logger;
            protected readonly Mock<IValidationRequest> _validationRequest;
            protected readonly PackageSigningProcessor _target;
            ...
            public FactsBase(ITestOutputHelper output)
            {
                ...
                _logger = loggerFactory.CreateLogger<PackageSigningProcessor>();
                ...
                _target = new PackageSigningProcessor(
