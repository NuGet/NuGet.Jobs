...
namespace NuGet.Services.Validation.Orchestrator.Tests
{
    ...
    /// </summary>
    public class ConfigurationIntegrationFacts
    {
        [Fact]
        public void ConfigurationRootDoesNotStoreData()
        {
            const string propertyValue = "Value";
            var configurationRoot = CreateConfigurationRoot(propertyValue, out Mock<IConfigurationProvider> mock);
        ...
        private static IConfigurationRoot CreateConfigurationRoot(string propertyValue, out Mock<IConfigurationProvider> configurationProviderMock)
        {
        ...
        {
            return CreateConfigurationRoot(propertyValue, out Mock<IConfigurationProvider> _);
        }
        ...
        private static Mock<IConfigurationProvider> CreateConfigurationProviderMock(string propertyValue)
        {
        ...
        private class TestConfigurationSource : IConfigurationSource
        {
            ...
            public Mock<IConfigurationProvider> LastMock { get; private set; }
