    ...
    public class IncidentEntityCollectorProcessorTests
    {
        ...
        public abstract class TheFetchSinceMethod : IncidentEntityCollectorProcessorTest
        {
            ...
            public async Task CreatesParsedIncidents()
            {
                ...
                Factory
                    .Setup(x => x.Create(It.IsAny<ParsedIncident>()))
                ...
                Factory
                    .Verify(
                        x => x.Create(firstFirstParsedIncident),
                        Times.Once());

                Factory
                    .Verify(
                        x => x.Create(secondFirstParsedIncident),
                        Times.Once());
            }
        }
        ...
        public class IncidentEntityCollectorProcessorTest
        {
            ...
            public Mock<IEntityFactory<IncidentEntity>> Factory { get; }
            ...
            public IncidentEntityCollectorProcessorTest()
            {
                ...
                Factory = new Mock<IEntityFactory<IncidentEntity>>();
