...
Invoke-BuildStep 'Set version metadata in AssemblyInfo.cs' { `
        $versionMetadata =
            ...
            "$PSScriptRoot\src\Monitoring.GitHubVulnerabilitiesLag\Properties\AssemblyInfo.g.cs"
...
Invoke-BuildStep 'Creating artifacts' {
        ...
        $NuspecProjects = `
            ...
            "src/Monitoring.GitHubVulnerabilitiesLag/Monitoring.GitHubVulnerabilitiesLag.csproj"
